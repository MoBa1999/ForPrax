...
model = Test_Model(input_length=max_length, tar_length=200, conv_1_dim=32,conv_2_dim=32, attention_dim=at_dim, num_reads=num_reads,
                 n_heads = n_heads, at_layer = at_layer, kernel_2=kernel_2, kernel_1 = kernel_1, kernel_1_2 = kernel_1_2)
